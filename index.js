...
exports.getTable = exports.getArticleWithBriefId = exports.getTableInfo = exports.getTableContent = exports.convertToMarkdown = exports.getPageContent = void 0;
var types_1 = require("./types");
var getPage = function (pageId) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fetch("https://www.notion.so/api/v3/loadPageChunk", {
                    body: JSON.stringify({
                        "pageId": pageId,
                        "limit": 50,
                        "cursor": {
...
var getTableContent = function (info) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fetch("https://www.notion.so/api/v3/queryCollection", {
                    body: JSON.stringify({
            ...
            case 2:
                ...
                return [2 /*return*/, Object.values(collectionData.recordMap.block).slice(2).filter(function (block) { return block.value.type === types_1.BlockType.page; }).map(function (block) {
...
var getTableInfo = function (pageId) { return __awaiter(void 0, void 0, void 0, function () {
    var pageData, _a, collectionId, viewId;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, getPage(pageId)];
            case 1:
                pageData = _b.sent();
                _a = (Object.values(pageData.recordMap.block)[0]).value, collectionId = _a.collection_id, viewId = _a.view_ids[0];
                return [2 /*return*/, {
